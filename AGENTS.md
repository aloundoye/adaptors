...
**Codex:** _[generates files]_

### Generating QA Tests

**User:** "Generate QA job code for this adaptor"

**Codex:** [Reads `.github/prompts/qa-job-generation.md` first]
```
<<<QA PLAN>>>
...
**Codex:** [Generates `qa-example-api.js` in root directory using template from qa-job-generation.md]
